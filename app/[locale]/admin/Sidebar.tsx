            ...
            >
                ...
                <div style={{ paddingBottom: '1rem', borderBottom: '1px solid var(--border-glass)', flexShrink: 0 }}>
                    <Link href="/" className="sidebar-link" style={{ color: 'var(--accent)', gap: '0.75rem', borderRadius: '12px', padding: '0.5rem' }}>
                        ...
                        <span style={{ fontSize: '1.1rem', fontWeight: 700 }}>
                            {t('admin_volver_al_inicio') === 'admin_volver_al_inicio' ? 'Volver al Sitio' : t('admin_volver_al_inicio')}
                        </span>
                    </Link>
                </div>
                ...
                <nav style={{ 
                    ...
                    {MENU_ITEMS.map((item) => {
                        ...
                        const translationKey = `admin_${item.name.toLowerCase().replace(/\s+/g, '_')}`;
                        const displayVal = t(translationKey);
                        const labelText = displayVal === translationKey ? item.name : displayVal;
                        return (
                            <Link 
                                key={item.href} 
                                href={item.href} 
                    ...
                    {!userLoading && hasControlOperativo && (
                        <>
                            <div style={{ 
                                ...
                                <span style={{ fontSize: '1.1rem', fontWeight: 700 }}>
                                    {t('admin_configuracion') === 'admin_configuracion' ? 'Configuración' : t('admin_configuracion')}
                                </span>
                            </div>
                            ...
                            {isSuperAdmin && (
                                <>
                                    ...
                                    >
                                        ...
                                        <span style={{ fontWeight: pathname === '/admin/super-reports' ? 700 : 500 }}>
                                            {t('admin_reportes_admin') === 'admin_reportes_admin' ? 'Reportes Admin' : t('admin_reportes_admin')}
                                        </span>
                                    </Link>
                                    ...
                                    >
                                        ...
                                        <span style={{ fontWeight: pathname === '/admin/users' ? 700 : 500 }}>
                                            {t('admin_usuarios') === 'admin_usuarios' ? 'Usuarios' : t('admin_usuarios')}
                                        </span>
                                    </Link>
                                </>
                            )}
                            ...
                            {hasControlOperativo && (
                                ...
                                >
                                    ...
                                    <span style={{ fontWeight: pathname === '/admin/billing' ? 700 : 500 }}>
                                        {t('admin_facturacion') === 'admin_facturacion' ? 'Facturación' : t('admin_facturacion')}
                                    </span>
                                </Link>
                            )}
                            ...
                            {isOperator && (
                                ...
                                >
                                    ...
                                    <span style={{ fontWeight: pathname === '/admin/about-operator' ? 700 : 500 }}>
                                        {t('admin_quienes_somos') === 'admin_quienes_somos' ? 'Quiénes Somos' : t('admin_quienes_somos')}
                                    </span>
                                </Link>
                            )}
                            ...
                            {isSuperAdmin && (
                                ...
                                >
                                    ...
                                    <span style={{ fontWeight: pathname === '/admin/about-admin' ? 700 : 500 }}>
                                        {t('admin_quienes_somos') === 'admin_quienes_somos' ? 'Quiénes Somos' : t('admin_quienes_somos')}
                                    </span>
                                </Link>
                            )}
